...
class Converter {
  ...
  static String taskStatusString(String state) {
    ...
    switch (state) {
      case '1':
        ...
        break;
      case '2':
        status = LocalStrings.awaitingFeedback.tr;
        break;
      case '3':
        status = LocalStrings.testing.tr;
        break;
      case '4':
        status = LocalStrings.inProgress.tr;
        break;
      case '5':
        status = LocalStrings.completed.tr;
        break;
    }
    return status;
  }
  ...
  static String taskPriorityString(String state) {
    ...
    switch (state) {
      case '1': // Low
        status = LocalStrings.priorityLow.tr;
        break;
      case '2': // Medium
        status = LocalStrings.priorityMedium.tr;
        break;
      case '3': // High
        status = LocalStrings.priorityHigh.tr;
        break;
      case '4': // Urgent
        status = LocalStrings.priorityUrgent.tr;
        break;
    }
    return status;
  }
